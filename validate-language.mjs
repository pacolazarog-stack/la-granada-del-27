...
for(const file of ['paco-pages-en-a.js','paco-pages-fr-a.js','paco-pages-it-a.js','paco-pages-de-a.js','paco-pages-b.js','paco-pages-en-b.js','paco-pages-fr-b.js','paco-pages-it-b.js','paco-pages-de-b.js','paco-pages-c.js','paco-pages-primavera-d.js','paco-pages-primavera-e.js','paco-pages-verano-a.js','paco-pages-verano-b.js','paco-pages-verano-c.js','paco-pages-verano-d.js','paco-pages-verano-e.js','paco-pages-otono-a.js','paco-pages-otono-b.js','paco-pages-otono-c.js','paco-pages-otono-d.js','paco-pages-nombres.js','paco-pages-superpaco-a.js','paco-pages-superpaco-b.js']){
  new Function(fs.readFileSync(file,'utf8'));
...
for(const lang of ['en','fr','it','de']){
  ...
  for(let i=0;i<=149;i++) assert(typeof pacoTranslations[lang][i]==='string'&&pacoTranslations[lang][i].trim(),'falta Paco página '+(i+1)+' en '+lang);
}
...
console.log('OK · Paco Olmo: páginas 1–150 × EN/FR/IT/DE; SUPERPACO cerrado e INVIERNO iniciado');
