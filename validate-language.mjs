...
for(const lang of ['en','fr','it','de']){
  ...
  for(let i=0;i<=132;i++) assert(typeof pacoTranslations[lang][i]==='string'&&pacoTranslations[lang][i].trim(),'falta Paco página '+(i+1)+' en '+lang);
}
...
console.log('OK · Paco Olmo: páginas 1–133 × EN/FR/IT/DE; LOS NOMBRES DE PACO cerrado');
