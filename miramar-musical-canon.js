(()=>{
  ...
  const cloneData=d=>({...d,pages:[...d.pages]});
  window.MIRAMAR_TEXTUAL_DATA=cloneData(window.WORK_DATA);
...
tan tum ta ah tan tum ta ah`
  ...
  window.MIRAMAR_MUSICAL_SCENE_TITLES=titles;
  ...
  function applyDataset(){
    ...
    if(musical){
      ...
      window.MIRAMAR_SCENE_TITLES={...titles};
  ...
  document.addEventListener('volume:soundchange',reloadForMode);
  document.addEventListener('volume:voicechange',reloadForMode);
})();