...
(()=>{
  ...
  const laVega={
    ...
    canonicalVerseCount:activeVega?.verseCount||42,
    ...
    retainedConstraints:[
      'tríptico 14 + 14 + 14',
      'umbral y cierre = dos apariciones del mismo verso central',
  ...
  window.GRANADA_SURFACE={
    ...
    laVega:{
      ...
      canonicalVerseCount:42,
      withheldFromPublicEdition:laVega.withheldFromPublicEdition,
      centralVerse:center,
      rule:'el tríptico se ancla a la matriz por un único verso central; no se comprime en 27 celdas'
    }
  };
})();
