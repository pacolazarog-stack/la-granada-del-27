...
3. **La poética del archivo** — ensayo, contraensayo, coda satírica y postdata; revisión integral 17/09/2026.
...
- El mapa termina y el agua continúa.
...
La revisión del **17/09/2026** actualiza la tesis del ensayo a la forma real del proyecto.

Ya no critica como presente la convivencia entre poemas y matriz: reconoce que el aparato formal ha sido separado del volumen literario y conservado en el **Atlas**. Incorpora **Cosiendo Europa** como evolución decisiva de la poética —de la celda al cauce, de la equivalencia a la diferencia— y mantiene la autocrítica mediante un contraensayo que también cuestiona esa propia corrección.

La edición digital se organiza en **22 páginas de lectura** y el texto fuente queda legible directamente en [`ensayo-01.js`](ensayo-01.js), sin el antiguo bloque comprimido.

Núcleo de la revisión:

> **La autocrítica solo tiene valor cuando modifica algo. De lo contrario, se convierte en otra carpeta.**

Y su réplica:

> **El sistema no ha desaparecido. Ha aprendido modales.**

El PDF y DOCX de Drive del 15/09/2026 quedan como masters históricos hasta que se regenere una edición impresa de esta revisión textual.

- PDF histórico: https://drive.google.com/file/d/1fBC_i2A2NkMjL0sXcQ1wliVcAADVViUi/view
- DOCX histórico: https://docs.google.com/document/d/1igdw-J7NQQntlXqDgQzbWD7SMiKZRaWd/edit

## Dossier crítico

**Poética del límite** reúne la crítica de *La Vega*, Miramar, el laboratorio formal, la constelación comparatista y la reflexión sobre inteligencia artificial y dirección autoral. El mapa crítico y las calificaciones pertenecen a este ámbito, no a la edición literaria.
...
## LA VEGA · centro 27³ · 20/09/2026

Se fija una nueva distinción entre **superficie** y **piedra**:

- **P14 de superficie** es el tríptico autoral **LA VEGA**, formado por 3 × 14 versos.
- Su verso axial único es **«Late bajo la cal la acequia hundida.»**; aparece gráficamente como umbral y cierre.
- La matriz profunda conserva **27 × 27 = 729 celdas** y el cubo conserva **27³ = 19.683 posiciones**.
- El anclaje común permanece en **14×14** y **14×14×14**.
- La antigua columna P14 de 27 versos queda como **LA VEGA · PROTOVERSIÓN 27**, archivo genético y material pétreo.
- **BAJO LA CAL** continúa como H14 de la piedra.
- El tríptico no se comprime dentro de 27 celdas: superficie, piedra y cubo coinciden únicamente en el verso central.
- Presentación canónica del tríptico: **una sola página, fondo verde pastel tenue, título reflejado, tres columnas y sin resaltado visible de los mesósticos**.
- Mientras convenga mantener el poema fuera de publicación, el repositorio público registra la arquitectura y retiene el texto completo de la superficie.

Canon técnico: [`LA_VEGA_CENTRO_27x27x27_CANON_2026-09-20.md`](LA_VEGA_CENTRO_27x27x27_CANON_2026-09-20.md).
