...
(()=>{
  ...
  /* Banda del canon musical completo: escenas 01–30. */
  const AUDIO_SRC='https://gcdn.picsart.com/editing-temp/8d08dd1a-0908-49b3-8d6d-1c6ac3716eb7.mpeg';
  const START=[0,68.836,174.200,249.202,305.340,469.228,574.710,723.848,849.826,984.106,1080.818,1237.410,1393.700,1489.870,1694.158,1818.910,1897.198,2005.238,2115.724,2278.337,2401.231,2488.871,2593.401,2682.139,2766.557,2866.197,3001.949,3150.780,3235.728,3601.008,3797.688];
  const TITLES=[
    'MIRAMAR COMUNIDAD','OK','EL CUERPO','CLAC','NADIE','NACE EL CONFLICTO','PRIMERA INCURSIÓN TERRESTRE','TERRITORIO','MAYORÍA SIMPLE','VOTEN','SIEMPRE SE HA HECHO','DERECHO','BANDERA','PROCLAMO','ESTADO','EL VIENTO','EL SOL','CONFORME A DERECHO','GARANTE','MIRAMAR','INNOVAR','SILENCIO','ARCHIVO','AUSENCIA','QUIÉN MIRA A QUIÉN','CÓMO SEGUIMOS','UMBRAL','EH COMUNIDAD','DIEZ MINUTOS','FINAL'
  ];
